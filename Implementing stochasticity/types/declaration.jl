...
mutable struct AddStochasticity
    ...
    function AddStochasticity(addstochasticity,θ,μ,σe,σd,stochspecies,stochconsumers,stochproducers) 
        new(addstochasticity,θ,μ,σe,σd,stochspecies,stochconsumers,stochproducers)
    end
end

"""
My Little Stressor Object
"""
mutable struct Stressor
    addstressor::Bool
    stressed_species::Vector{<:Real}
    slope::Float64

    function Stressor(addstressor, stressed_species, slope) 
        new(addstressor, stressed_species, slope) 
    end
end
...
mutable struct ModelParameters 
    ...
    AddStochasticity::AddStochasticity
    Stressor::Stressor
end
